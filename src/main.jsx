  ...
  <Router history={browserHistory}>
    <Route path="/" component={Nav}>
      ...
      <Route
        ...
        getComponent={(location, cb) => {
          require.ensure([], require => {
            const BlogPostList = require('./components/BlogPostList.jsx').default
      ...
      <Route
        ...
        getComponent={(location, cb) => {
          require.ensure([], require => {
            const ProjectList = require('./components/Projects.jsx').default
            cb(null, ProjectList)
          }, 'Projects')
        }}
      />
      <Route
        ...
        getComponent={(location, cb) => {
          require.ensure([], require => {
            const BlogPostWrapper = require('./components/BlogPostComponents.jsx').default
